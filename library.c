...
void DrawLine(u16 * BitmapAddress, u8 x1, u8 y1, u8 x2, u8 y2, u8 Colour)
{
	...
	if (x2==x1)
	{
		DrawLineVertical((u16 *)BitmapAddress, x1, y1, y2, Colour);
	}
	else if (y2==y1)
	{
		DrawLineHorizontal((u16 *)BitmapAddress, x1, x2, y1, Colour);
	}
	else
	{
...
//Two specific cases for vertical and horizontal lines for speed.
// Can be called directly if you know you are drawing boxes, otherwise will be inferred from DrawLine() above
...
void DrawLineHorizontal(u16 * BitmapAddress, u16 x1, u16 x2, u16 y, u16 Colour)
{
	...
	// Could be made quicker if we know that a line is going to go across a full tile?
